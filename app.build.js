...
},{"./stop":11}],3:[function(require,module,exports){
...
},{"fs":5}],10:[function(require,module,exports){
var d3 = require('d3')
...
},{"./starplot":10,"./views/details.jade":13,"array-uniq":4,"d3":6,"hammerjs":8}],12:[function(require,module,exports){
var Hammer = require('hammerjs')
...
buf.push("<button>X</button><h2>" + (jade.escape(null == (jade_interp = data.name) ? "" : jade_interp)) + "</h2><h3>Verkehrsverbünde</h3><ul>");
// iterate data.agencies
;(function(){
  var $$obj = data.agencies;
...
if ( (item === 'BMO---'))
{
buf.push("<li>Busverkehr Märkisch-Oderland GmbH</li>");
}
if ( (item === 'BON---'))
{
buf.push("<li>Busverkehr Oder-Spree GmbH</li>");
}
if ( (item === 'BVB---'))
{
buf.push("<li>Berliner Verkehrsbetriebe</li>");
}
if ( (item === 'HVG---'))
{
buf.push("<li>Havelbus Verkehrsgesellschaft mbH</li>");
}
if ( (item === 'N01---'))
{
buf.push("<li>DB Regio AG</li>");
}
if ( (item === 'UVGG__'))
{
buf.push("<li>Uckermärkische Verkehrsgesellschaft</li>");
}
    }
...
buf.push("<span>" + (jade.escape(null == (jade_interp = item + ', ') ? "" : jade_interp)) + "</span>");
    }
...
if ( (item === '700'))
{
buf.push("<span>Bus, </span>");
}
else
{
buf.push("<span>Bahn, </span>");
}
    }
...
buf.push("<h3>Fahrten pro Woche</h3><p>" + (jade.escape(null == (jade_interp = data.tripCount) ? "" : jade_interp)) + "</p><h3>Durchschnittliche Fahrten/Linie</h3><p>" + (jade.escape(null == (jade_interp = data.averageTripsPerRoute) ? "" : jade_interp)) + "</p>");}.call(this,"data" in locals_for_with?locals_for_with.data:typeof data!=="undefined"?data:undefined,"undefined" in locals_for_with?locals_for_with.undefined:typeof undefined!=="undefined"?undefined:undefined));;return buf.join("");
};
},{"jade/runtime":9}],14:[function(require,module,exports){
...
},{"./filter":1,"./generateStops":2,"./getJSON":3,"./starplot":10,"./stopList":12,"domready":7}]},{},[14]);
